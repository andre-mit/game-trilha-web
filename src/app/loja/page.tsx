      ...
      <div className="container mx-auto mt-28">
        <div className="flex flex-wrap -mx-4">
          {itens.map((item, index) => (
            ...
            >
              <div className="bg-green-300 shadow-md w-64 h-48">
              ...
              <span className="inline-block text-xl w-2/4 bg-red-600 rounded-md p-2 shadow-xl">
                R$ 300,00
              </span>
              <button className="bg-green-500 text-xl w-2/4 text-white rounded-md p-2 shadow-xl">
                Comprar
              </button>
            </div>
          ))}
